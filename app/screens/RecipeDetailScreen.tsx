...
interface Meal {
  ...
  strYoutube?: string;
  [key: string]: any; // Allow extra properties from the API response
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ChevronLeftIcon size={hp(3.5)} strokeWidth={4.5} color="#fb923d" />
        </TouchableOpacity>
        <TouchableOpacity
      ...
      {loading ? (
        ...
        <View className="px-4 flex justify-between gap-y-4 pt-8">
          {/* name and area */}
          <Animated.View
          ...
          >
            <View className="flex rounded-full bg-orange-300 p-2">
              <View
            ...
            {meal && (
              <View className="gap-y-2 ml-3">
                {ingredientsIndexes(meal).map((i) => {
                  return (
                    <View key={i} className="flex-row gap-x-4">
                      <View
          ...
          {meal?.strYoutube && (
            ...
            >
              ...
              <View>
                <YoutubeIframe
                  videoId={getYoutubeVideoId(meal?.strYoutube) || undefined}
                  height={hp(30)}
                />
              </View>
            </Animated.View>
